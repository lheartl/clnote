<?php /* Template_ 2.2.7 2015/07/30 21:42:45 G:\web\work\note\eyoom\theme\pc_basic\skin_mo\qa\basic\list.skin.html 000006300 */  $this->include_("eb_paging");
...
<tr>
<td rowspan="2" class="t-center"><?php echo $TPL_V1["num"]?></td>
<?php if($GLOBALS["is_checkbox"]){?>
...
<span class="<?php if($TPL_V1["qa_status"]){?>txt_done<?php }else{?>txt_rdy<?php }?>"><?php if($TPL_V1["qa_status"]){?>답변완료<?php }else{?>답변대기<?php }?></span>&nbsp;&nbsp;[<?php echo $TPL_V1["category"]?>]&nbsp;&nbsp;<?php echo $TPL_V1["name"]?>&nbsp;&nbsp;<?php echo $TPL_V1["date"]?>
</td>
</tr>
<?php }}else{?>
